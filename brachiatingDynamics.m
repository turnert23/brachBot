...
theta1_ddot = (i1.*i2+2.*i2.*lc1.^2.*m1+i2.*lc1.^2.*m2+2.*i1.*lc2.^2.*m2+i2.* ...
  lc2.^2.*m2+4.*lc1.^2.*lc2.^2.*m1.*m2+2.*lc1.^2.*lc2.^2.*m2.^2+ ...
  lc2.^4.*m2.^2+2.*lc1.*lc2.^3.*m2.^2.*cos(theta2)+(-1).*lc1.^2.* ...
  lc2.^2.*m2.^2.*cos (theta2).^2).^(-1).*((-1).*i2.*tau+(-1).*lc2.^2.*...
  m2.*tau+(-1).*lc1.*lc2.*m2.*tau.*cos(theta2)+(-1).*g.*i2.*lc1.*m1.* ...
  sin(theta1)+(-1).*g.*i2.*lc1.*m2.*sin(theta1)+(-2).*g.*lc1.* ...
  lc2.^2.*m1.*m2.*sin(theta1)+(-0.15E1).*g.*lc1.*lc2.^2.*m2.^2.*sin( ...
  theta1)+lc1.*lc2.*m2.*(2.*i2+4.*lc2.^2.*m2).*theta1_dot.*theta2_dot.*sin(theta2)+lc1.*lc2.*m2.*(i2+ ...
  2.*lc2.^2.*m2).*theta2_dot.^2.*sin(theta2)+lc1.* ...
  lc2.*m2.*theta1_dot.^2.*((i2+lc2.^2.*m2).*sin( ...
  theta2)+0.5E0.*lc1.*lc2.*m2.*sin(2.*theta2))+(-1).*g.*lc2.^3.* ...
  m2.^2.*sin(theta1+theta2)+0.5E0.*g.*lc1.*lc2.^2.*m2.^2.*sin( ...
  theta1+2.*theta2));

theta2_ddot = (i1.*i2+2.*i2.*lc1.^2.*m1+i2.*lc1.^2.*m2+2.*i1.*lc2.^2.*m2+i2.* ...
  lc2.^2.*m2+4.*lc1.^2.*lc2.^2.*m1.*m2+2.*lc1.^2.*lc2.^2.*m2.^2+ ...
  lc2.^4.*m2.^2+2.*lc1.*lc2.^3.*m2.^2.*cos(theta2)+(-1).*lc1.^2.* ...
  lc2.^2.*m2.^2.*cos (theta2).^2).^(-1).*(i1.*tau+i2.*tau+2.*lc1.^2.* ...
  m1.*tau+lc1.^2.*m2.*tau+lc2.^2.*m2.*tau+2.*lc1.*lc2.*m2.*tau.*cos( ...
  theta2)+g.*i2.*lc1.*m1.*sin(theta1)+g.*i2.*lc1.*m2.*sin(theta1)+ ...
  g.*lc1.*lc2.^2.*m1.*m2.*sin(theta1)+g.*lc1.*lc2.^2.*m2.^2.*sin( ...
  theta1)+(-1).*g.*i1.*lc2.*m2.*cos (theta2).*sin(theta1)+(-1).*g.* ...
  lc1.^2.*lc2.*m1.*m2.*cos (theta2).*sin(theta1)+(-1).*g.*lc1.* ...
  lc2.^2.*m2.^2.*cos (theta2).^2.*sin(theta1)+(-1).*g.*i1.*lc2.*m2.* ...
  cos (theta1).*sin(theta2)+(-2).*g.*lc1.^2.*lc2.*m1.*m2.*cos(theta1)...
  .*sin(theta2)+(-1).*g.*lc1.^2.*lc2.*m2.^2.*cos (theta1).*sin( ...
  theta2)+(-1).*g.*lc1.*lc2.^2.*m2.^2.*cos (theta1).*cos (theta2).* ...
  sin(theta2)+lc1.*lc2.*m2.*theta1_dot.*theta2_dot.*(...
  ((-2).*i2+(-2).*lc2.^2.*m2).*sin(theta2)+(-1).*lc1.*lc2.*m2.*sin( ...
  2.*theta2))+lc1.*lc2.*m2.*theta1_dot.^2.*(((-1).*i1+(-1).*i2+(-2).* ...
  lc1.^2.*m1+(-1).*lc1.^2.*m2+(-1).*lc2.^2.*m2).*sin(theta2)+(-1).* ...
  lc1.*lc2.*m2.*sin(2.*theta2))+lc1.*lc2.*m2.*theta2_dot.^2.*(((-1).*i2+(-1).*lc2.^2.*m2).*sin(theta2)+(-0.5E0).* ...
